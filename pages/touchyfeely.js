...
export default function Home() {
  return (
    <div className={styles.page}>
      ...
      <Image alt="intpaint" style={{display: "flex", margin: "auto", flexDirection: "row", justifyContent: "center"}} width={850} height={620} className={styles.img} src="/home/image.png"/>
 ...
 <Row style={{paddingTop: "40px"}}>
      <Col>
        ...
        <Image alt="intpaint"  width={500} height={420} className={styles.img} src="/src/eqlist.png"/>

      </Col>

      <Col>
       <Image alt="intpaint"  width={470} height={460} className={styles.img} src="/src/3.jpg"/>
      </Col>
      </Row>
      ...
      <Image alt="intpaint"  width={800} height={180} src="/src/phys-digital.png"/>

      <Row>
         <h3 className={styles.text}>Physical to Digital Process</h3>
        <Col style={{ display: "flex", justifyContent: "space-around"}} >
          <Image alt="intpaint"  width={450} height={450}  src="/src/1R0A3083.jpg"/>
          <Image alt="intpaint"  width={450} height={450}  src="/src/1R0A3085.jpg"/>
        </Col>
        ...
        <div className={styles.videoContainer} style={{paddingTop: "40px"}}>
          <iframe width="100%" height="400px" class="responsive-iframe" src="https://www.youtube.com/embed/svcvmbKqDow" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
