...
export default function Home() {
  return (
    <div className={styles.page}>
      ...
      <Header/>
      <main>
      <Image alt="wtmxer" width={820} height={420} style={{display: "flex", margin: "auto", flexDirection: "row", justifyContent: "center"}} src="/home/wtmxer.gif"/>
      <div className={styles.container}> 
        ...
        <Row>
          <Col style={{display: "flex", margin: "auto", flexDirection: "row", justifyContent: "center"}} className={styles.text}>
            <h6>Equipments:</h6>
            <ul>
          ...
          <Col style={{paddingTop: "6px"}}>
            <Image alt="wtmxer" width={420} height={420} style={{marginLeft: "6px"}} src="/src/IMG_3813.jpg"/>

          </Col>
        </Row>
        <Row>
          <Col style={{paddingTop: "6px"}}>
            <Image alt="wtmxer" width={480} height={420} src="/src/circ1.png"/>
            <Image alt="wtmxer" width={480} height={420} style={{marginLeft: "8px"}} src="/src/circ2.png"/>
          </Col>
        </Row>
        <Row>
          <Col style={{paddingTop: "6px"}}>
            <Image alt="wtmxer" width={320} height={320} src="/src/test1.jpg"/>
            <Image alt="wtmxer" width={320} height={320} style={{marginLeft: "6px"}} src="/src/test2.jpg"/>
            <Image alt="wtmxer" width={320} height={320} style={{marginLeft: "6px"}} src="/src/lehim.jpg"/>
          </Col>
        </Row>
        <Row>
          <Col style={{paddingTop: "6px"}}>
